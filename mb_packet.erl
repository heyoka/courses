%% @author heyoka
%% @doc Handle Modbus packet creation and parsing.
...
-define(READ_COILS_EXCEPTION, 					0x81).
-define(READ_DISCRETE_INPUTS, 					0x02).
-define(READ_HOLDING_REGISTERS, 					0x03).
-define(READ_HOLDING_REGISTERS_EXCEPTION, 	0x83).
-define(READ_INPUT_REGISTERS, 					0x04).

-define(WRITE_SINGLE_COIL, 						0x05).
-define(WRITE_SINGLE_COIL_EXCEPTION, 			0x85).
-define(WRITE_SINGLE_REGISTER, 					0x06).
-define(WRITE_SINGLE_REGISTER_EXCEPTION, 		0x86).
-define(WRITE_MULTIPLE_COILS, 					0x0f).
-define(WRITE_MULTIPLE_REGISTERS, 				0x10).
-define(WRITE_MULTIPLE_REGISTERS_EXCEPTION, 	0x90).

-define(SINGLE_COIL_OFF, 							0x0000).
-define(SINGLE_COIL_ON, 							0xff00).
